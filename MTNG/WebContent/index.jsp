...
<body> <!--
	...
	<div>
        <div class="header-blue" style="padding-bottom:60px;height:70px;">
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container"><a class="navbar-brand" href="#">MTNG</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse"
                        id="navcol-1">
                        <ul class="nav navbar-nav">
                            <li class="nav-item" role="presentation"><a class="nav-link active invisible" href="#">Link</a></li>
                            <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle invisible" data-toggle="dropdown" aria-expanded="false" href="#">Dropdown </a>
                                <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="#">First Item</a><a class="dropdown-item" role="presentation" href="#">Second Item</a><a class="dropdown-item" role="presentation" href="#">Third Item</a></div>
                            </li>
                        </ul>
                        <form class="form-inline mr-auto" target="_self">
                            <div class="form-group"><label class="invisible" for="search-field"><i class="fa fa-search"></i></label><input class="form-control search-field" type="search" name="search" id="search-field"></div>
    ...
    <div>
        <div class="container" style="margin-right:0;margin-left:0;background-color:transparent;padding-right:0;padding-left:0;width:auto;max-width:none;">
            <div class="row" style="margin-right:0px;margin-left:0px;min-width:95%;padding-right:0px;padding-left:0px;">
                <div class="col-12 col-lg-3 col-xl-3 offset-xl-1" style="margin:0;margin-left:10;padding-right:10;">
                    <h1>Instructions</h1>
                    <p>You won't believe how easy it is to create our polls</p><button class="btn btn-light btn-lg action-button" type="button">Learn More</button></div>
                <div class="col-11 col-sm-12 col-md-auto col-lg-8 col-xl-8 offset-lg-1 offset-xl-0 d-sm-inline-block d-md-inline-block d-lg-block d-xl-inline-block phone-holder"
                    ...
                    <div id="surveyContainer" style="background-color:transparent;width:41%;min-height:5px;font-size:16px;"></div>
                </div>
            </div>
        </div>
    </div>
